...
public class LpSolve {
	...
	static {
		...
		System.out.println("Before Library Load........");
		System.loadLibrary("lpsolve55j");
		//System.load("ipsolver");
    ...
    public static void main(String[] args) {
        try {
            ...
            LpSolve solver = LpSolve.makeLp(3, 4);
	...
	/**
	 * Set the type of the variable. int or floating point.
	 */
	public native void setInt(int colnr, boolean mustBeInteger) throws LpSolveException;

	/**
	 * Get the type of the variable. int or floating point.
	 */
