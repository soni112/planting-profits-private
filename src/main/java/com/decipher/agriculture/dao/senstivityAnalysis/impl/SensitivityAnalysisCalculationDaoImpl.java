...
//                        currentPotentialProfit = temp;
                    ...
                    if(i == 0){
                        jsonObject.put("bubbleMessage", "This is the base amount for " + (resourceName == null ? (((selectionType.equals("Crop") || selectionType.equals("Group")) ? rangeType + " acres of " : "") + cropName) : (resourceName)));
