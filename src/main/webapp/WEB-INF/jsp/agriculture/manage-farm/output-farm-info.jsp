					...
					<div class="base_white">
						<ul class="total_output" id="sidemenu">
							<c:choose>
								<c:when test="${model.farmInfoView.strategy eq 'PLAN_BY_ACRES'}">
									<li class="active"><a href="#Crop-Acreage" class="open">
										...
										<div class="right_detail"> Crop Acreage<!-- <span>You can see the acreage of each crop planted.</span> --></div>
									</a></li>
								</c:when>
								<c:otherwise>
									<li class="active"><a href="#Crop-Acreage" class="open">
							...
							<c:if test="${model.farmInfoView.strategy eq 'PLAN_BY_FIELDS'}">
								<li><a href="#Crop&ndash;Field-Assignments" >
									...
									<div class="right_detail"> Crop &ndash; Field Assignments<!-- <span>You can see crop to field allocation.</span> --></div>
								</a></li>
							</c:if>
							<li><a href="#Resource-Use">
								<div class="lf_pointer_images"><img src="<c:url value="/images/pointer-image3.jpg"/>"></div>
								<div class="right_detail"> Resource Use<!-- <span>You can see which resources you use.</span> --></div>
							</a></li>
							<li><a href="#Crop-Limits">
								<div class="lf_pointer_images"><img src="<c:url value="/images/pointer-image4.jpg"/>"></div>
								<div class="right_detail"> Crop Acreage Limits<!-- <span>You can see your min. &amp; max. crop limits.</span> --></div>
							</a></li>
							<li><a href="#Forward-Sales">
								<div class="lf_pointer_images"><img src="<c:url value="/images/pointer-image5.jpg"/>"></div>
								<div class="right_detail"> Forward Sales<!-- <span>You can see your contract crop.</span> --></div>
							</a></li>
						</ul>
						<ul class="potential_criteria">
							<li>Estimated Income:
								<span class="baseline_potential_profit" id="potentialProfit">$${model.potentialProfit}</span>
							</li>
						...
						<div class="contentblock" id="Crop-Acreage">
							<div id="cropAcerageText" class="text_field" style="display: none">
								<div class="addremove-field padding-left-none pull-right">
									<a id="cropAcerageGraphShow" class="show_graph"><img src="<c:url value="/images/graph_tab.png"/>"></a>
								</div>
								<div class="clearfix"></div>
								<div class="table-responsive Crop-Acreage-tabel" style="max-height: 298px;">
									<table width="100%" cellspacing="0" id="cropAcreageAndProfit" class="table table-striped tbl-bordr  tblbrdr output_table">
										<thead>
							...
							<div id="cropAcerageGraph" class="graph_field" style="display: block">
								<div class="addremove-field padding-left-none pull-right">
									<a id="cropAcerageTextShow" class="show_text"><img src="<c:url value="/images/showtext.png"/>"></a>
								</div>
								<div class="clr"></div>
								<div class="graph_area">
									...
									<ul data-persist="true" class="tabs">
										<li class="selected">
											<a href="#by_acres"><span class="icon"><img src="<c:url value="/images/acres_icon.png"/>"></span> &nbsp;By Acres</a>
										</li>
										<li class="">
											<a href="#by_profit"><span class="icon"><img src="<c:url value="/images/profit.png"/>"></span> &nbsp;By Profit</a>
										</li>
									</ul>
						...
						<c:if test="${model.farmInfoView.strategy eq 'PLAN_BY_FIELDS'}">
							<div class="contentblock hidden" id="Crop&ndash;Field-Assignments">
								<div class="table-responsive" style="max-height: 298px;">
									<table width="100%" cellspacing="0" class="table table-striped tbl-bordr tblbrdr output_table">
										<thead>
										<tr class="tblhd add-fieldi">
						...
						<div class="contentblock hidden" id="Resource-Use">
							<div id="resourceUseText" class="text_field" style="display: none">
								<div class="addremove-field padding-left-none pull-right">
									<a id="resourceUseGraphShow" class="show_graph"><img src="<c:url value="/images/resource_graph_btn.png"/>"></a>
								</div>
								<div class="clearfix"></div>
								<div class="table-responsive Crop-Acreage-tabel" style="max-height: 298px;">
							...
							<div id="resourceUseGraph" class="graph_field" style="display: block">
								<div class="addremove-field padding-left-none pull-right">
									<a id="resourceUseTextShow" class="show_text"><img src="<c:url value="/images/showtext.png"/>"></a>
								</div>
								<div class="clr"></div>
								<div class="graph_area">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<h3 class="panel-title inc_dec_title">
										...
										<a class="help_Infromation_PopUp" id="resourceSestivityDiv" style="padding-left: 10px">
											<img src="<c:url value="/images/i-icon.png"/>">
										</a>
									</h3>
								...
								<div class="panel-body" style="display: none;">
									<ul class="tabs" data-persist="true">
										...
										<li class="">
											...
											<img class="help_Infromation_PopUp" id="resourceSestivityMultipleDiv" src="<c:url value="/images/i-icon.png"/>">
										</li>
									</ul>
									<div class="sensitive_analysis_container">
										<div id="single_resource" style="display: block;">
											...
											<div class="resource_value">
												...
												<div class="yellobtn sensitive_updatebtn">
													<a id="forCastGraphSubmitButtonForSingleResource" onclick="forCastGraphForSingleResource()">Analyze</a>
												</div>
												<%--	@added - Abhishek 	@date - 25-02-2016		@desc - According to slide#12 of 02212016	--%>
												<div class="sensitive_updatebtn">
													<a class="help_Infromation_PopUp" id="SAChangeInPotentialProfitResource" style="padding-left: 10px">
														<img src="<c:url value="/images/i-icon.png"/>">
													</a>
												</div>
											</div>
										...
										<div id="multiple_resources" style="display: none;">
											...
											<div class="baseline">
												...
												<p class="static_result_shown">
													Estimated Income from change to Baseline: <span class="new_potential_profit">$${model.potentialProfit}</span>
												</p>
												<p class="static_result_shown">
											...
											<div style="width: 50%; float: right;">
												...
												<!--
                                                    ...
                                                    @Date - 25-11-2015
                                                -->
												<div class="yellobtn pre_next" onclick="getStrategyForMultipleResources()">
													<a>Analyze</a>
												</div>
												<!--
                                                    @Changed - Abhishek
                                                    @Date - 10-12-2015
                                                -->
												<div id="multipleResourceViewStrategy" class="yellobtn pre_next hidden" onclick="showSensetiveAnalysisCropAndResourcePopup(); return false;">
													<a>View Strategy</a>
												</div>
											</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<h3 class="panel-title inc_dec_title">
										...
										Increase or decrease Crop Acreage Limits to analyze the impact on Estimated Income
										<a class="help_Infromation_PopUp" id="cropLimitSestivityDiv" style="padding-left: 10px">
											<img src="<c:url value="/images/i-icon.png"/>">
										</a>
									</h3>
                                    <span class="pull-right clickable panel-collapsed"><i class="fa fa-chevron-down"></i></span>
								...
								<div class="panel-body" style="display: none;">
									<ul class="tabs" data-persist="true">
										...
										<li class="">
											...
											<img class="help_Infromation_PopUp" id="cropLimitSestivityMultipleDiv" src="<c:url value="/images/i-icon.png"/>">
										</li>
									</ul>
									<div class="sensitive_analysis_container">
										<div id="single_crop_limit" style="display: block;">
											...
											<div class="resource_value">
												<div class="pull-right">
													<div style="margin-bottom: 3%;">
														...
														<a href="javascript:;" onclick="navigateToCropLimits(); return false;" style="text-decoration: underline;">Crop Acreage Limits</a>
													</div>
												</div>
												<div class="clearfix"></div>
												...
												<div class="value_input width-26">
													...
													<select id="forCastGraphCropList" onchange="switchForContractOrProposed(); checkMinMaxForCrop(this); return false;">
														<option value="">Select crop</option>
                                                        <c:set value="0" var="cropLimitFlag" />
														<c:forEach var="cropTypeForCropLimit" items="${model.cropTypeView}">
																...
																<c:if test="${(cropTypeForCropLimit.minimumAcres ne '' and cropTypeForCropLimit.minimumAcres ne '0')
																	...
																	<c:choose>
																		<c:when test="${cropTypeForCropLimit.selected and cropTypeForCropLimit.firmchecked eq 'true'}">
																			<option value="Contract#-#-#${cropTypeForCropLimit.cropName}#-#-#${cropTypeForCropLimit.id}">${cropTypeForCropLimit.cropName} (Firm)</option>
																		</c:when>
																		<c:when test="${cropTypeForCropLimit.selected and cropTypeForCropLimit.proposedchecked eq 'true'}">
																			<option value="Proposed#-#-#${cropTypeForCropLimit.cropName}#-#-#${cropTypeForCropLimit.id}">${cropTypeForCropLimit.cropName} (Proposed)</option>
																		</c:when>
																	</c:choose>
																</c:if>
															</c:if>
														...
														<c:forEach var="cropsGroupView" items="${model.cropsGroupViews}">
												...
												<div class="value_input width-16">
													<div class="yellobtn sensitive_updatebtn">
														<a id="forCastGraphSubmitButtonForSingleCrop" onclick="forCastGraphForSingleCropLimit()">Analyze</a>
														<!--  onclick="forCastGraphForSingleCropLimit()" -->
													</div>
													<%--	@added - Abhishek 	@date - 25-02-2016		@desc - According to slide#13 of 02212016	--%>
													<div class="sensitive_updatebtn">
														<a class="help_Infromation_PopUp" id="SAChangeInPotentialProfitCropLimits"  style="padding-left: 5px">
															<img src="<c:url value="/images/i-icon.png"/> ">
														</a>
													</div>
												</div>
											...
											<div class="box box-info">
												<div class="box-body chart-responsive">
													<div id="forCastSingleCropLimitchartdiv" style="width: 100%; height: 400px; background-color: #FFFFFF; margin-top: 12px; float: left; display: none;"></div>
												</div>
												<!-- /.box-body -->
											</div>
										...
										<div id="multiple_crop_limit" style="display: none;">
												...
												<table cellspacing="0" class="table table-striped tbl-bordr tblbrdr text-center multiple_resource_table">
															...
															<tr class="tblgrn">
																...
																<td class="success">
																	<c:choose>
																		...
																		<c:otherwise>
																			-
																			<input type="hidden" value="${cropListForCropLimit.minimumAcres}">
																		</c:otherwise>
																	</c:choose>
																...
																<td class="success">
																	<c:choose>
																		...
																		<c:otherwise>
																			-
																			<input type="hidden" value="${cropListForCropLimit.maximumAcres}">
																		</c:otherwise>
																	</c:choose>
													...
													<c:forEach var="cropListForCropLimit" items="${model.cropTypeView}">
														<c:if test="${cropListForCropLimit.selected and cropListForCropLimit.firmchecked eq 'true'
															...
															<c:set var="multipleCropsLimitsFlag" value="1" />
															<tr class="tblgrn">
																<td class="success">${cropListForCropLimit.cropName} (Firm)</td>
																...
																<td class="success">
																	<c:choose>
																		...
																		<c:otherwise>
																			-
																			<input type="hidden" value="${cropListForCropLimit.forwardAcres}">
																		</c:otherwise>
																	</c:choose>
																	...
																	<c:choose>
																		<c:when test="${cropListForCropLimit.forwardAcres ne '' and cropListForCropLimit.forwardAcres ne '0'}">
																			<input type="text"
																				   onchange="addCommaSignWithOutDollarDot(this);"
																				   onkeypress="return isValidNumberValueForWithOutDot(event)"
																				   value="${cropListForCropLimit.forwardAcres}"></td>
																		</c:when>
																	<c:otherwise>
																		-
																		<input type="hidden" value="${cropListForCropLimit.forwardAcres}">
													...
													<c:forEach var="cropsGroupViewsList" items="${model.cropsGroupViews}">
															...
															<tr class="tblgrn">
																...
																<td class="success">
																	<c:choose>
																		...
																		<c:otherwise>
																			-
																			<input type="hidden" value="${cropsGroupViewsList.minimumAcres}">
																		</c:otherwise>
																	</c:choose>
																...
																<td class="success">
																	<c:choose>
																		...
																		<c:otherwise>
																			-
																			<input type="hidden" value="${cropsGroupViewsList.maximumAcres}">
																		</c:otherwise>
																	</c:choose>
											...
											<div class="baseline">
												...
												<div id="viewStrategyMultipleCrops" class="yellobtn pre_next hidden" onclick="showSensetiveAnalysisCropAndResourcePopup(); return;">
													<a>View Strategy</a>
												</div>
											</div>
...
<div id="criticalMessageForCropOrGroupPopUp" style="display: none;">
	<div id="popupContact">
		<!-- Planning Form -->
		<div class="popup_section">
			<img class="closePopup" onclick="$('#criticalMessageForCropOrGroupPopUp').hide()" src="<c:url value="/images/cross.png"/>">
			<div class="popupform messagepopup potencial_profit_popup">
				<div class="increase_profit">
					<p>
		...
		<div class="popup_section">
			...
			<div class="popupform messagepopup create_scenario_section">
					...
					<div class="graph_area">
						...
						<ul class="tabs" data-persist="true">
							<li class="selected" id="createScenarioGraphShowByFieldLi">
								...
								<a href="#createScenarioGraphShowByFieldDiv"> <span class="icon"><img src="<c:url value="/images/acres_icon.png"/>"></span>&nbsp;By Acres</a>
							</li>
							<li class="" id="createScenarioGraphShowByCropsLi">
								...
								<a href="#createScenarioGraphShowByCropsDiv"><span class="icon"> <img src="<c:url value="/images/profit.png"/>"></span>&nbsp;By Profit</a>
							</li>
						</ul>
						<div class="home-search-tab-container">
							<div id="createScenarioGraphShowByFieldDiv" style="display: block;">
								<div id="createScenarioGraphShowByFieldGraph" class="chartdiv" style="width: 100%; height: 300px;"></div>
							</div>
							<div id="createScenarioGraphShowByCropsDiv" style="display: none;">
								<div id="createScenarioGraphShowByCropsGraph" class="chartdiv" style="width: 100%; height: 300px;"></div>
							</div>
						</div>
						<!--Horizontal tabs end-->
					</div>
				...
				<div id="createScenarioText" class="text_field">
					<div class="addremove-field padding-left-none pull-right">
						<a class="show_graph" id="createScenarioGraphShow"> <img src="<c:url value="/images/graph_tab.png"/>"></a>
					</div>
					<div class="clr"></div>
					<ul class="tabs" data-persist="true">
						<li class="selected">
							<a href="#senstivity-output-tab"> <span class="icon"><i class="fa fa-bar-chart-o"></i></span>&nbsp;Strategy Output</a>
						</li>
						<li>
							<a href="#senstivity-output-crop-field-tab"><span class="icon"> <i class="fa fa-paw"></i></span>&nbsp;Crop/Field</a>
						</li>
					</ul>
					<div class="home-search-tab-container">
						...
						<div id="senstivity-output-crop-field-tab" style="display: none;">
							<div class="table-responsive Crop-Acreage-tabel" id="show_strategy_for_scenario">
								<table width='100%' cellspacing='0' class='table table-striped tbl-bordr  tblbrdr output_table' id="strategyDetailsTable">
									<thead></thead>
									<tbody></tbody>
								</table>
							</div>
				...
				<div class="panel panel-default strategy_for_scenario">
					<div class="panel-heading">
						<h3 class="panel-title inc_dec_title"><p class="scenario_heading" id="scenario_heading"></p></h3>
