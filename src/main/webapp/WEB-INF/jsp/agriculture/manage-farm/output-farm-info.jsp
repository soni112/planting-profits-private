                                        ...
                                        <div id="multiple_resources" style="display: none;">
                                            ...
                                            <div style="width: 50%; float: right;">
                                                ...
                                                <div id="available-acreage-not-planted-msg" style="margin-left: -10px; display: none">
                                                    All acres are not assigned crops.
                                                    <c:url value="/troubleshoot.htm" var="troubleshooturl">
                                                        <c:param name="farmId" value="${farmId}"/>
                                                        <c:param name="key" value="unused"/>
                                                    </c:url>
                                ...
                                <table width="100%" cellspacing="0"
                                    ...
                                    <tr class="tblheader add-fieldi">
                                        ...
                                        <c:if test="${model.farmInfoView.strategy ne 'PLAN_BY_FIELDS'}">
                                            <td>Impacting<br>Est. Income</td>
                                            <td>To Increase<br>Est. Income</td>
                                        </c:if>
                                            ...
                                            <div class="table-responsive Crop-Acreage-tabel">
                                                <table cellspacing="0"
                                                    ...
                                                    <c:if test="${multipleCropsLimitsFlag eq 0}">
                                                        <tr class="tblgrn">
                                                            <td class="success" colspan="5">No Crop Limits Specified.</td>
                                                        </tr>
                                                    </c:if>
                                                    </tbody>
                                                </table>
    ...
    <div id="popupContact" style="left: 33%; width: 35%;">
        ...
        <div class="popup_section">
            ...
            <div class="popupform messagepopup">
                <ul class="potential_criteria">
                    <li style="display: none"><span id="sensetiveAnalysisCropAndResourceValueForSingle"></span></li>
