									...
									<c:choose>
										<c:when test="${model.farmInfoView.strategy eq 'PLAN_BY_FIELDS'}">
											<div class="col-lg-2 col-md-3 col-sm-3 padding-left-none option_selection">
												<label>
													<input type="radio" class="strategy" name="plan_by_farm" value="fields" checked="checked"><span>Fields</span>
												</label>
											</div>
											<div class="col-lg-2 col-md-3 col-sm-3 option_selection">
												<label>
													<input type="radio" class="strategy" name="plan_by_farm" value="acres"><span>Acres</span>
												</label>
											</div>
										...
										<c:when test="${model.farmInfoView.strategy eq 'PLAN_BY_ACRES'}">
											<div class="col-lg-2 col-md-3 col-sm-3 padding-left-none option_selection">
												<label>
													<input type="radio" class="strategy" name="plan_by_farm" value="fields"><span>Fields</span>
												</label>
											</div>
											<div class="col-lg-2 col-md-3 col-sm-3 option_selection">
												<label>
													<input type="radio" class="strategy" name="plan_by_farm" value="acres" checked="checked"><span>Acres</span>
												</label>
											</div>
											<div class="col-lg-3 col-md-4 col-sm-4 option_selection">
												<!-- <label> <input type="radio" class="strategy" name="plan_by_farm" value="both" ><span>Both</span></label> -->
...
<div class="col-lg-3 col-md-4 col-sm-4  add-field padding-right-none"><a onclick="removeField()"><img src="images/remove.png"></a></div> -->
											...
											<tbody id="plan-by-field-tbody"
												...
												<c:forEach var="fieldList" items="${model.fieldInfoList}">
													...
													<tr class="success tblgrn text-center">
														<td><input id="row-field-manage_checkbox__${rowCount}" type="checkbox" class="fields"></td>
														<td id="row-field-name__${rowCount}">${fieldList.fieldName}</td>
														<td id="row-field-size__${rowCount}">${fieldList.fieldSizeStr}</td>
														<td><select onchange="lastCropSelected(this)" id="selected_last_crop____${rowCount}">
								...
								<div id="add-new-crop-pop-up" class="common-pop-class-for-all">
									<div id="popupContact">
										<!-- Planning Form -->
										<div class="popup_section">
											<img onclick="div_hide4()" src="<c:url value="/images/cross.png"/>" id="close">
											<h2
							...
							<div class="form_area">
																	...
																	<li class="col-lg-4 col-md-4 col-sm-6 padding-left-none">
																		...
																		<label class="labelForCrops">
																			<input type="checkbox" name="field_crop[]"
																				...
																				class="crops" value="${farm.cropName}"
								...
								<div id="add-new-crop-and-crop-info"
									...
									<div id="popupContact">
										<!-- Planning Form -->
										<div class="popup_section">
											<img id="close" src="<c:url value="/images/cross.png"/>" onclick="div_hide5()">
											<h2 class="popupheadercrop"
												style="padding: 0 0 0 22px; color: #BE922F; font-weight: bold;">Add Crop</h2>
											<div class="popupform messagepopup"
											...
											<tbody id="crop_information_tbody">
												...
												<c:forEach var="farm" items="${model.cropTypeView}">
													...
													<c:if test="${farm.selected}">
														<tr class="tblbclgrnd text-center" id="crop_info_details__${rowCount}">
															<td class="tblft1" id="crop_info_details_field_crop_name__${rowCount}">${farm.cropName}</td>
															<td class="success uomtext">
																<select onchange="changeCropUOM(this)" class="crop_selection_UOM">
																	<option value="bushels" ${farm.cropUOM eq 'bushels'?'selected':''}>bushels</option>
																	<option value="crates" ${farm.cropUOM eq 'crates'?'selected':''}>crates</option>
																	<option value="hundredweight" ${farm.cropUOM eq 'hundredweight'?'selected':''}>hundredweight</option>
																	<option value="kilograms" ${farm.cropUOM eq 'kilograms'?'selected':''}>kilograms</option>
																	<option value="pounds" ${farm.cropUOM eq 'pounds'?'selected':''}>pounds</option>
																	<option value="tons" ${farm.cropUOM eq 'tons'?'selected':''}>tons</option>
																	<option value="sacks" ${farm.cropUOM eq 'sacks'?'selected':''}>sacks</option>
																	<option value="bales" ${farm.cropUOM eq 'bales'?'selected':''}>bales</option>
																</select>
															</td>
															<td class="success infotext">
																<input type="text"
																	...
																	id="crop_info_yields_expected__${rowCount}" name="Crop"
															...
															<td class="success infotext"><input type="text"
																...
																onkeypress="return isValidNumberValue(event)"
																id="crop_info_yields_min__${rowCount}" name="Crop"
																value="${farm.intMinCropYieldStr}"></td>
															<td class="success infotext"><input
															...
															<td class="success infotext"><input type="text"
																onchange="addCommaSignWithDollar(this);calculateProfitByCrop(this)"
																onkeypress="return isValidNumberValue(event)"
																id="crop_info_price_max__${rowCount}" name="Crop"
																value="${farm.intMaxCropPriceString}"></td>
															<td class="success infotext"><input type="text"
																onchange="addCommaSignWithDollar(this);calculateProfitByCrop(this)"
																onkeypress="return isValidNumberValue(event)"
																id="crop_info_price_min__${rowCount}" name="Crop"
																value="${farm.intMinCropPriceString}"></td>
															<td class="success infotext">
															<input type="text" onchange="addCommaSignWithDollar(this);variableProductionCostChange(this);calculateProfitByCrop(this)"
																placeholder="$0"
																onkeypress="return isValidNumberValue(event)"
																...
																<br> <span class="pull-right"><a
																	onclick="showOptionalCropInformationDiv('${farm.cropName}')">Details</a></span></td>
															<td class="success infotext" onmouseover="showPotentialProfitCriticalMessagePopup(this);">
                                                                <c:set scope="page" value="" var="p_profit"/>
                                                                <c:choose>
                                                                    <c:when test="${farm.calculatedProfitFloatPrimitiveType le 0.0}">
                                                                        <c:set scope="page" var="p_profit" value="-$${cfun:absFloat(farm.calculatedProfitFloatPrimitiveType)}" />
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <c:set scope="page" var="p_profit" value="$${farm.calculatedProfitFloatPrimitiveType}" />
                                                                    </c:otherwise>
                                                                </c:choose>
																<input type="text" disabled="disabled" placeholder="$0" value="${farm.calculatedProfitFloat ne '' ? p_profit : '$0.00'}" class="<c:if test="${farm.calculatedProfitFloat ne '' and farm.calculatedProfitFloatPrimitiveType le 0.0}">errorClassWithRedColor</c:if>"/>
																<span class="text-center" style="color: grey;font-size: small;">
										...
										<div id="collapseOptionalCropInfo" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="table-responsive" style="max-height: 225px;">
													<table id="cropInformationDetailSecondTable" class="table table-striped tbl-bordr  tblbrdr" cellspacing="0" width="100%">
														<thead>
														<tr class="tblhd text-center add-fieldi">
															<td class="tblbrdr text-center add-fieldi">Crop</td>
															<!--	@changed - Abhishek		@date - 30-12-2015 -->
														...
														<c:forEach var="farm" items="${model.cropTypeView}">
															...
															<c:if test="${farm.selected}">
																<tr class="tblgrn text-center"
																	...
																	<td class="tblft1" id="optional_crop_info_field_crop_name__${rowCount}">${farm.cropName}</td>
																	<!--	@changed - Abhishek		@date - 30-12-2015 -->
																	...
																	<td class="success hidden"><input type="checkbox" id="optional_crop_info_irrigated__${rowCount}" value="true" ${farm.irrigated eq 'true'?'checked':''} /></td>
														...
														<c:forEach var="farm" items="${model.cropTypeView}">
															<c:if test="${farm.selected}">
																<tr class="tblgrn text-center"
																	...
																	<td class="success infotext"><input
																			class="datepicker"
																			value="${farm.latePlantingDateStr}" type="text"
																			id="optional_planting_date_late_planting_date__${rowCount}"
																			name="Crop"></td>
																	<td class="success infotext"><input
																			value="${farm.lengthofSeasonStr}" type="text"
															...
															<c:forEach var="cropTypeView" items="${model.cropTypeView}">
																<c:if test="${cropTypeView.selected}">
																	<tr class="tblbclgrnd text-center">
																		...
																		<td class="success infotext">
																			<input type="text" class="governmentPaymentsSpecific"
																				   onkeypress="return isValidNumberValue(event)"
																		...
																		<td class="success infotext">
																			<input type="text" class="additionalVariableCostSpecific"
																				   onkeypress="return isValidNumberValue(event)"
																				   onchange="addCommaSignWithDollar(this); calculateAdditionalCropProfit(this, true); return false;"
																				   value="${cropTypeView.additionalVariableProductionCostString}">
																		</td>
																		<td class="success infotext">
																			<input type="text" class="additionalIncomeSpecific"
																				   onkeypress="return isValidNumberValue(event)"
																				   onchange="addCommaSignWithDollar(this); return false;"
																				   value="${cropTypeView.additionalIncomeString}" disabled>
																		</td>
																	</tr>
																</c:if>
															</c:forEach>
													...
													<tfoot>
														...
														<tr class="tblft text-center">
															...
															<td><input type="hidden"
																...
																value="${cropList.cropNameForId}" class="tblgrn"></td>
															<td></td>
															<td class="tblgrn"
...
<div style="float: right; width: 19%;" class="col-lg-3 col-md-5 col-sm-5  addremove-field"><a onclick="allCheckboxSelect()"><img src="images/select-all.png"></a></div></div> -->
								...
								<div class="ques">
									<div class="table-responsive" <%--style="overflow: auto; max-height: 265px;"--%>>
										<table class="table table-striped tbl-bordr tblbrdr fld-chc-tbl-fixd-hdr" cellspacing="0" width="100%" id="field_choice_crop_table">
											<thead id="field_choice_crop_thead">

												<!--       Crop/Field Choices dynamic table genarate details get by Crop/Field Choices View list -->

												<tr class="tblhd text-center add-fieldi" id="field_choice_crop_thead_row_first">
													<td class="tblbrdr text-center add-fieldi" id="field_choice_crop_thead_row_column__1">
														Field/Crop</td>
													<c:set var="headCount" value="2" />
													<c:forEach var="cropForHead" items="${model.cropTypeView}">
														<c:if test="${cropForHead.selected}">
															<td class="text-center add-fieldi" id="field_choice_crop_thead_row_column__${headCount}">${cropForHead.cropName}</td>
...
<c:set var="lastCropName" value="fieldList.lastCrop"></c:set>
														...
														<c:forEach var="cropFieldsChoice" items="${model.cropFieldsDetails}">


															<c:if test="${cropFieldsChoice.fieldName.fieldName eq cropFieldsList.fieldName}">
																<td id="field_choice_crop_tbody_row_others_column__${rowFieldCount}__column__${columnCropCount}" class="success">
																	<label>
																		<input type="checkbox"
...
<div class="col-lg-3 col-md-5 col-sm-5  addremove-field padding-left-none"><a onclick="removeResourse()"><img src="images/remove_resources.png"></a></div> -->
													...
													<c:choose>
														<c:when test="${resourceListForManageResource.cropResourceUse eq 'Land'}">
															<tr class="tblgrn text-center"
																...
																<td id="total_land_available" class="success croplimit">${resourceListForManageResource.cropResourceUseAmount}</td>
															</tr>
														</c:when>
														<c:when
                ...
                start -->
																...
																<td class="croplimit"><input type="text"
																	...
																	value="$${resourceListForManageResource.cropResourceUseAmount}"></td>
																<!--                  end -->
															</tr>
														</c:when>
													</c:choose>
															...
															<c:if
																...
																<tr class="tblgrn text-center"
																	...
																	<td class="tblft1"><input type="checkbox"
																		...
																		name="resourceSelection"
																		id="manage_resource_row_checkbox__${rowCount}"
																	    <c:if test="${resourceListForManageResource.isActive()}">checked="checked"</c:if>></td>
									...
									<div class="maintbl" style="max-height: 250px;">
										<table id="crop_resource_usage"
											...
											<thead id="crop_resource_usage_thead">
												<tr id="crop_resource_usage_thead_first_row" class="tblhd text-center add-fieldi">
													<td class="tblbrdr text-center tittle-uppercase" id="crop_resource_usage_thead_first_row_column__1">Crop</td>
													<td class="text-center tittle-uppercase UOMCropResourceUsage" id="crop_resource_usage_thead_first_row_column__2">Yields<br>
														<span class="resub">(UoM acre)</span>
													</td>
													<td class="text-center tittle-uppercase" id="crop_resource_usage_thead_first_row_column__3">Variable Production Cost<br>
														...
														<span><a class="help_Infromation_PopUp" id="variable_production_cost_resourse"><img src="<c:url value="/images/i-icon.png"/>"></a></span>
													</td>
													...
													<c:if test="${cropList.selected}">
														<tr id="crop_resource_usage_row__${rowCount}" class="tblgrn text-center">
															<c:choose>
																...
																<c:otherwise>
																	<td id="crop_resource_usage_crop__${rowCount}" class="tblft1">${cropList.cropName}</td>
																</c:otherwise>
															</c:choose>
															<td class="success infotext tittle-uppercase UOMCropResourceUsage" id="crop_resource_usage_row_uomValue__${rowCount}">${cropList.cropUOM}</td>
															<td class="success infotext"
							...
							<div class="form_area">
								...
								<div class="ques">
									<div class="col-lg-6 col-md-6 col-sm-6 pull-left text-right">
										<select class="variance" onchange="fieldSelectFieldVarience(this)" id="field_select_drop_down">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 pull-right text-left">
										<select onchange="getFieldYieldDiffence(this)" class="variance" id="crop_select_drop_down">
											...
											<c:forEach var="cropListForVariences" items="${model.cropTypeView}">
												<c:if test="${cropListForVariences.selected}">
													...
													<c:if test="${cropListForVariences.id eq cropListForVariences.cropIdForVariences}">
														<c:set var="selected_field_difference_crop" value="${cropListForVariences.cropName}" />
													</c:if>
...
<option>Select Crop3</option> -->
														...
														<c:forEach var="cropList" items="${model.cropTypeView}">
															<c:if test="${cropList.selected}">
																<c:if test="${cropList.cropIdForVariences eq cropList.id}">
																	<c:set var="yieldDifferenceStatus" value="${yieldDifferenceStatus+1}" />
																	<!--  end -->
																	<tr class="tblgrn text-center">
																		<td class="tblft1">Expected</td>
																		<td class="success infotext" id="crop_Yield_Difference_Expected">${cropList.intExpCropYield}</td>
																		<td class="success infotext">
																			<input type="text" id="field_difference_exp"
																				onchange="addCommaSignWithForOnePoint(this)" onkeypress="return isValidNumberValue(event)"
																				name="${cropList.cropName}" value="${cropList.expCropYieldFieldStr}"/>
																		</td>
																	</tr>
																	<tr class="tblbclgrnd text-center">
																		<td class="tblft1">Minimum</td>
																		<td class="infotext" id="crop_Yield_Difference_Minimum">${cropList.intMinCropYield eq '.0' ? '' : cropList.intMinCropYield}</td>
																		<td class="infotext">
																			<input type="text" id="field_difference_min"
																				onchange="addCommaSignWithForOnePoint(this)" onkeypress="return isValidNumberValue(event)"
																				name="${cropList.cropName}" value="${cropList.minCropYieldFieldStr}"/>
																		</td>
																	</tr>
																	<tr class="tblgrn text-center">
																		<td class="tblft1">Maximum</td>
																		<td class="success infotext" id="crop_Yield_Difference_Maximum">${cropList.intMaxCropYield eq '.0' ? '' : cropList.intMaxCropYield}</td>
																		<td class="success infotext">
																			<input type="text" id="field_difference_max"
																				onchange="addCommaSignWithForOnePoint(this)" onkeypress="return isValidNumberValue(event)"
																				name="${cropList.cropName}" value="${cropList.maxCropYieldFieldStr}"/>
																		</td>
																	</tr>
																</c:if>
															</c:if>
        ...
        start -->
														<c:if test="${yieldDifferenceStatus eq 1}">
															<tr class="tblgrn text-center">
																<td class="tblft1">Expected</td>
																<td class="success infotext" id="crop_Yield_Difference_Expected"></td>
																<td class="success infotext">
																	<input type="text" id="field_difference_exp"
																		onchange="addCommaSignWithForOnePoint(this)" onkeypress="return isValidNumberValue(event)"/>
																</td>
															...
															<tr class="tblgrn text-center">
																<td class="tblft1">Maximum</td>
																<td class="success infotext" id="crop_Yield_Difference_Maximum"></td>
																<td class="success infotext">
																	<input type="text" id="field_difference_max"
																		onchange="addCommaSignWithForOnePoint(this)" onkeypress="return isValidNumberValue(event)" />
																</td>
														...
														<c:forEach var="resourceListForCropResourcesUsages" items="${model.cropTypeView}">
															<c:if
																...
																<tr class="tblgrn text-center"
																	...
																	<td class="tblft1 tittle-uppercase" id="resources_usages_difference_row_resource_name">Variable Production Cost</td>
																	<td class="success infotext" id="resources_usages_production_resource_default">${resourceListForCropResourcesUsages.calculatedVariableProductionCostFloat}</td>
																	<td class="success infotext">
																		<input type="text" id="resources_usages_production_cost_resource_override"
																			   onchange="addCommaSignWithDollar(this)" onkeypress="return isValidNumberValue(event)"
																			   value="${resourceListForCropResourcesUsages.varProductionCostStr}">
																	</td>
																</tr>
																<c:set var="cropIdForResourceUsageDifference" value="${resourceListForCropResourcesUsages.cropIdForVariences}" />
																<c:set var="resourceUsageDifferenceStatus" value="${resourceUsageDifferenceStatus+1}" />
															</c:if>
														</c:forEach>
		...
		start -->
														<c:if test="${resourceUsageDifferenceStatus eq 1}">
															<tr class="tblgrn text-center"
																id="resources_usages_production_row">
																<td class="tblft1 tittle-uppercase" id="resources_usages_difference_row_resource_name">Variable Production Cost</td>
																<td class="success infotext" id="resources_usages_production_resource_default"></td>
																<td class="success infotext">
																	<input type="text" id="resources_usages_production_cost_resource_override"
																		   onchange="addCommaSignWithDollar(this)" onkeypress="return isValidNumberValue(event)">
																</td>
														...
														<c:forEach var="resourceListForCropResourcesUsages" items="${model.resourceList}">
															<!-- details start -->
															...
															<c:if
																...
																<tr id="resources_usages_difference_row__${resourceNo}" class="tblgrn text-center">
																	...
																	<c:forEach var="resourceVariances" items="${model.resourceVariancesList}">
																		<c:if test="${resourceVariances.cropName eq selected_field_difference_crop and resourceVariances.cropFieldResourceUse eq resourceListForCropResourcesUsages.cropResourceUse}">
																			<td id="resources_usages_difference_row__${resourceNo}_resource_default" class="success infotext">
																	...
																	<c:if test="${flagForfieldDifference eq '0'}">
																		<td id="resources_usages_difference_row__${resourceNo}_resource_default" class="success infotext"></td>
																	</c:if>
																	<%-- 			<c:if test="${resourceListForCropResourcesUsages.id eq resourceListForCropResourcesUsages.resourseUsageId}"> --%>
																	<td class="success infotext">
																		<input type="text" id="resources_usages_difference_row__${resourceNo}_resource_override"
																			onkeypress="return isValidNumberValue(event)" onchange="addCommaSignWithOutDollar(this)"
														...
														<tr id="forward_sales_information_tbody_row__${forwardSalesRowCount}" class="tblbclgrnd text-center">
															...
															<td class="success croplimit">
																<input type="text"
																	...
																	onkeypress="return isValidNumberValue(event)"
																	onchange="addCommaSignWithOutDollarDot(this);acerageCalForwardSale(this)"></td>
															<td class="success croplimit">
																<input type="text"
																	id="forward_sales_information_tbody_row_acres__${forwardSalesRowCount}"
																	value="${cropListForforwardSale.acresStr}"
																	onkeypress="return isValidNumberValue(event)"
																	onchange="addCommaSignWithOutDollarDot(this);quantityCalForwardSale(this)"></td>
															<td class="success croplimit">
																<input type="checkbox"
																	onchange="proposedAndFirmSelection(this)"
																	id="forward_sales_information_tbody_row_proposed__${forwardSalesRowCount}"
																	value="true"
																	${cropListForforwardSale.proposedchecked eq true ? 'checked':''}></td>
															<td class="success croplimit">
																<input type="checkbox"
																	onchange="proposedAndFirmSelection(this)"
																	id="forward_sales_information_tbody_row_firm__${forwardSalesRowCount}"
																	value="true"
																	${cropListForforwardSale.firmchecked eq 'true' ? 'checked':''}></td>
															<td id="forward_sales_information_tbody_row_upper_limit__${forwardSalesRowCount}" class="success croplimit hidden">
																<input type="text"
							...
							<div class="form_area">
								...
								<div class="ques">
									<div class="table-responsive" style="max-height: 230px;">  <%--crop-limits-tbl-fixd-hdr--%>
										<table id="crop_limits_table" class="table table-striped tbl-bordr  tblbrdr" cellspacing="0" width="100%">
											<thead>
												<tr class="tblhd text-center add-fieldi">
											...
											<tbody id="crop_limits_table_tbody">
												...
												<c:forEach var="cropListForCropLimit" items="${model.cropTypeView}">
													...
													<c:if test="${cropListForCropLimit.selected}">
														<tr id="crop_limits_table_tbody_row__${rowCountForCropLimit}" class="tblbclgrnd text-center">
															<td class="tblft1"></td>
...
<div style="display: none;" id="critical-message-pop-up">
	<div id="popupContact">
		<!-- Planning Form -->
		<div class="popup_section">
			<img src="<c:url value="/images/cross.png"/>" onclick="hidePotentialProfitCriticalMessagePopup()" id="close">
...
<div style="display: none;" id="save-strategy-popoup" class="pop-up">
	<div class="pop-up-body">
		<!-- Planning Form -->
		<div class="popup_section">
			<img onclick="closeStrategyOrBaselinePopup(); return false;" src="<c:url value="/images/cross.png"/>" class="img-close">
			<div class="popupform messagepopup potencial_profit_popup">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 padding-left-none medium-height-overflow medium-height-overRide">
							...
							<div style="margin-top: 1%">
								<button class="alertify-button alertify-button-ok pull-right"
										onclick="saveAllFarmInformation(); return false;" >Ok</button>
								<button class="alertify-button alertify-button-cancel pull-right"
										onclick="closeStrategyOrBaselinePopup(); return false;">Cancel</button>
							</div>
						</div>
