                        ...
                        <ul class="planning">
                            ...
                            <li>
                                ...
                                <div id="cropChoices" class="collapse">
                                    Minimum crop acreage limits, combined with limitations on which crops can be grown
                                    in which fields may make some combinations of
                                ...
                                <%--<link to crop/field choices page>--%><br/>
                                    ...
                                    increase the number of fields where the crop
                                    (s)<br/>
