...
function getFieldYieldDiffence(obj) {
    ...
    if($(obj).val() == sessionStorage.getItem('selectTwo') && strSelect1==sessionStorage.getItem('selectFirst')){
        $('#selectFieldDifference').html('').html(sessionStorage.getItem('newInputHtml'));
    }
