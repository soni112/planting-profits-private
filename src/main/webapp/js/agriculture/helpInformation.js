...
var diversification = "<p> % of a strategy’s Est. Income generated by one crop in the strategy.</p>";

var forwardSales = "<p>% of a strategy’s Est. Income forward sold to reduce price risk.</p>";

var returnOnWorkingCapital = "<p>Return on Working Capital is a measure of the efficiency of a crop to generate a dollar of estimated income for a dollar of Working Capital used.\n" +
	"<p> It is the Estimated Income divided by the Variable production costs for a given crop.</p> " +
	"</p>";
